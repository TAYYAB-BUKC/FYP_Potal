<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLOMapping.aspx.cs" Inherits="FYP_Portal.Web.PLOMapping" %>
...
<title>Program Learning Outcome Mapping</title>
...
<div class="wrapper">
	...
	<header class="header-nav menu_style_home_one dashbord_pages navbar-scrolltofixed stricky main-menu">
		...
		<a class="dropdown-item active" id="sp" runat="server" href="FYPCoordinatorProfileInfo.aspx">My Profile</a>
                ...
                <li class="user_setting">
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	...
					    	<div class="user_setting_content">
	<a class="dropdown-item active" id="sp1" runat="server" href="FYPCoordinatorProfileInfo.aspx">My Profile</a>
...
<li class="active"><a runat="server" href="PLOMapping.aspx"><span class="flaticon-add-contact"></span> PLO Mapping </a></li>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Program Learning Outcome Mapping</h4>
							</nav>
						</div>
