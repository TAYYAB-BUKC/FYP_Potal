<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportSheet.aspx.cs" Inherits="FYP_Portal.Web.ReportSheet" %>
...
<title>Report Evaluation Sheet</title>
...
<li class="active"><a runat="server" href="ReportSheet.aspx"><span class="flaticon-rating"></span>Report Sheet</a></li>
...
<li><a runat="server" href="Files.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Report Evaluation Sheet</h4>
							</nav>
						</div>
 ...
 <form id="form1" runat="server">    	
    ...
    <asp:DropDownList ID="reports" Width="100%" class="form-control" AutoPostBack="true" runat="server" OnSelectedIndexChanged="reports_SelectedIndexChanged">
   ...
   <asp:listitem text="Final Year Evaluation"></asp:listitem>
	...
	<div class="my_profile_setting_input form-group">
 <h4> Group Names </h4>
 <asp:DropDownList ID="groupNumber" Width="100%" Enabled="true" AutoPostBack="true" 
     OnSelectedIndexChanged="groupNumber_SelectedIndexChanged" class="form-control" runat="server" >
   </asp:DropDownList>
     </div>							
</div>
	...
	<div class="col-xl-6">
<div class="my_profile_setting_input form-group">						    	              
 <h4>Final Year Project Titles</h4> 
     <asp:TextBox ID="fyptitle" class="form-control" Width="100%" runat="server"></asp:TextBox>    
        <asp:Button ID="GenerateReport" class="btn btn-primary" runat="server" Text="Generate Report" OnClick="GenerateReport_Click" />
       </div>
     ...
     <asp:Label ID="MessageLabel" runat="server" Text=""></asp:Label>
         ...
         ShowFooter="false" ClientIDMode="Static">
 ...
 <Columns>
    ...
    <EditItemTemplate>
     ...
     <label class="control-label" runat="server" id="stdLabel">  Student Name </label> 
 <asp:DropDownList ID="studentName" Width="100%" Enabled="true" class="form-control" runat="server" OnSelectedIndexChanged="studentName_SelectedIndexChanged" AutoPostBack="true" >
   </asp:DropDownList>                           
