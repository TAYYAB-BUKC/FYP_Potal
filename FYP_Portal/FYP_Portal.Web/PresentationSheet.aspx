<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PresentationSheet.aspx.cs" Inherits="FYP_Portal.Web.PresentationSheet" %>
...
<title>Presentation Evaluation Sheet</title>
		        ...
		        <ul class="header_user_notif pull-right dn-smd">
	                <li class="user_setting">
					 ...
					 <br /> <br /> 
								...
								<a class="dropdown-item active" id="sp" runat="server" href="SupervisorProfileInfo.aspx">My Profile</a>
                ...
                <li class="user_setting">
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	...
					    	<div class="user_setting_content">
							<a class="dropdown-item active" id="sp1" runat="server" href="SupervisorProfileInfo.aspx">My Profile</a>
...
<div id="myDrop2" class="drop-content">
    <ul>
<li class="active"><a runat="server" href="PresentationSheet.aspx"><span class="flaticon-rating"></span>Presentation Sheet</a></li>
...
<li><a runat="server" href="Files.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Presentation Evaluation Sheet</h4>
							</nav>
						</div>
 ...
 <asp:DropDownList ID="studentName" Width="100%" Enabled="true" class="form-control" runat="server" OnSelectedIndexChanged="studentName_SelectedIndexChanged" AutoPostBack="true" >
     ...
     <asp:Label ID="fyptitleLabel" runat="server" Text="FYP Title"></asp:Label> <br />
