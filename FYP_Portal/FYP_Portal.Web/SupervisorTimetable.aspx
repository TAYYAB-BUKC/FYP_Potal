<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupervisorTimetable.aspx.cs" Inherits="FYP_Portal.Web.SupervisorTimetable" %>
...
<title>Supervisor Timetables</title>
...
<div id="myDrop2" class="drop-content">
    <ul>
    <li class="active"><a runat="server" href="SupervisorTimetable.aspx"><span class="flaticon-like"></span> Supervisor Timetable</a></li>
...
<li><a runat="server" href="GradeDetailsForFYPCoordinator.aspx"><span class="flaticon-rating"></span>Student Grades</a></li>
 ...
 <div class="dd">
  ...
  <div class="dd-content">
	...
	<div class="col-lg-12">
		<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
			<h4 class="title float-left">Supervisors Timetable</h4>
		</nav>
	</div>
  ...
  <table id="std_table" class="table table-nonbordered table-condensed info table-responsive tableCol1">
            ...
            <tr>               
          <td>  <asp:DropDownList ID="supervisors" Width="90%" class="form-control" runat="server">                                                             
                </asp:DropDownList>
          </td>   
