<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PresentationEvaluation.aspx.cs" Inherits="FYP_Portal.Web.PresentationEvaluation" %>
...
<div id="myDrop1" class="drop-content">
    <ul>
<li class="active"><a runat="server" href="PresentationEvaluation.aspx"><span class="flaticon-rating"></span>Presentation Evaluation</a></li>
...
<li><a runat="server" href="Files.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Presentation Evaluation</h4>
							</nav>
						</div>
 ...
 <Columns>
  ...
  <ControlStyle Height="20px" Width="20px" />
      ...
      <asp:DropDownList ID="studentName" Width="100%" Visible="false" Enabled="true" class="form-control" runat="server" OnSelectedIndexChanged="studentName_SelectedIndexChanged" AutoPostBack="true" >
   </asp:DropDownList> 
