<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="FYP_Portal.Web.Notifications" %>
...
<section class="dashboard_sidebar dn-1199">
     ...
     <ul>
		...
		<li class="active"><a runat="server" href="Notifications.aspx"><span class="flaticon-speech-bubble"></span>Notifications</a></li>
...
<asp:RequiredFieldValidator ID="rfv3" runat="server" ControlToValidate="subject" Display="Dynamic" 
 ...
 <asp:TextBox id="subject" name="form_subject" class="form-control required" required="required" Width="700px" type="text" runat="server"></asp:TextBox>
...
<asp:RequiredFieldValidator ID="rfv4" runat="server" ControlToValidate="messages" Display="Dynamic" 
 ...
 <textarea class="form-control required" ID="messages"  cols="20" rows="5" runat="server"></textarea>
    </div>
 ...
 <asp:Button ID="BtnSend" class="btn btn-primary" runat="server" Text="Send" OnClick="BtnSend_Click" />
              ...
              <asp:Label ID="em" type="hidden" runat="server" ></asp:Label>
							      </div>                     
                        	   </div>
							</div>		
                          </div>      
