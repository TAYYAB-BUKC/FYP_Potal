<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCLO.aspx.cs" Inherits="FYP_Portal.Web.AddCLO" %>
...
<div id="myDrop1" class="drop-content">
    <ul>
<li class="active"><a runat="server" href="AddCLO.aspx"><span class="flaticon-rating"></span>Add CLO </a></li>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
		...
		<div class="col-lg-12">
			<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
				<h4 class="title float-left">Course Learning Outcomes</h4>										
			</nav>
		</div>
  		...
  		<div class="col-lg-12">
           ...
           <asp:Label ID="name" runat="server" Text="CLO "></asp:Label>
           <input id="CLOnumber" class="form-control" runat="server" type="number"/> <br />

<asp:Label runat="server" Text="Description: ">
<asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="Description" Display="Dynamic" 
ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
</asp:Label> <br />
<textarea ID="Description" class="form-control" cols="85" rows="3" runat="server"></textarea> <br /> 

<asp:Label runat="server" Text="OutStanding">
<asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="outs" 
Display="Dynamic" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
</asp:Label> <br />
<textarea ID="outs" class="form-control" cols="85" rows="3" runat="server"></textarea>  <br />

 <asp:Label runat="server" Text="Good">
     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="good" Display="Dynamic" 
ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
 </asp:Label> <br />
 <textarea id="good" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />

<asp:Label  runat="server" Text="Average">
 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="avg" Display="Dynamic" 
ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
</asp:Label>  <br />
<textarea id="avg" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />
                             
<asp:Label runat="server" Text="Satisfactory">
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="satisfactory" Display="Dynamic" 
ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
</asp:Label><br />
<textarea id="satisfactory" class="form-control" cols="85" rows="3" runat="server"></textarea><br />

<asp:Label runat="server" Text="Poor">
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="poor" Display="Dynamic" 
ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
</asp:Label><br />
<textarea id="poor" class="form-control" cols="85" rows="3" runat="server"></textarea><br />

<asp:Label runat="server" Text="Fail">
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="fail" Display="Dynamic" 
ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
</asp:Label><br />
<textarea id="fail" class="form-control" cols="85" rows="3" runat="server"></textarea><br />

<asp:Button ID="btnsave" class="btn btn-primary" runat="server" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Text="Add" width="100px" OnClick="btnsave_Click"/>
