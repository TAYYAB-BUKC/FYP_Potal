<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Documentation.aspx.cs" Inherits="FYP_Portal.Web.Documentation" %>
...
<div id="myDrop3" class="drop-content">
    ...
    <li><a runat="server" href="EIMapping.aspx"><span class="flaticon-like"></span> E.I Mapping</a></li>
                    ...
                    <br /><br />
<ul>
<li class="active"><a runat="server" href="Documentation.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
...
<div class="col-lg-12">
	<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
		<h4 class="title float-left">Documents</h4>
          ...
          <table id="std_table" class="table table-nonbordered table-condensed info table-responsive tableCol4">
              <tbody>
             ...
             <tr>               
          <td> <asp:TextBox ID="doctitle" class="form-control" runat="server"></asp:TextBox> </td>                   
           <td> 
<input type="text" class="form-control" placeholder="Start Date" id="datepicker1" runat="server"/>
               <br />              
           </td>    
                 
                 <td> 
  <input type="text" class="form-control" placeholder="End Date" id="datepicker2"  runat="server"/>
                 </td>
           ...
           <td> <asp:FileUpload ID="FileUpload1" runat="server"/>
            ...
            <td>       
<asp:Button ID="BtnUpload1" class="btn btn-primary" runat="server" Text="Upload" 
