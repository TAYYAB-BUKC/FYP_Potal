<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPLO.aspx.cs" Inherits="FYP_Portal.Web.AddPLO" %>
...
<li class="active"><a runat="server" href="AddPLO.aspx"><span class="flaticon-add-contact"></span>Add PLO </a></li>
...
<li><a runat="server" href="GradeDetailsForCoordinator.aspx"><span class="flaticon-rating"></span>Student Grades</a></li>
</ul>                       
  ...
  <div class="dd-content">
	...
	<div class="col-lg-12">
		<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
			<h4 class="title float-left">Program Learning Outcomes</h4>
		</nav>
	</div>
...
<asp:Label ID="name" runat="server" Text="PLO "></asp:Label>
 <input id="PLOnumber" runat="server" class="form-control" type="number" min="1" max="12" maxlength="2" />
      <br /> 
...
<asp:Button ID="btnsave" class="btn btn-primary" runat="server" Text="Add" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Width="100px" OnClick="btnsave_Click"/>
                             <br /><br />
         </form>
