<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FYPCoordinatorChangePassword.aspx.cs" Inherits="FYP_Portal.Web.FYPCoordinatorChangePassword" %>
						...
						<div class="dropdown">
						    ...
						    <div class="dropdown-menu">
						    	...
						    	<div class="user_setting_content">
									<a class="dropdown-item" id="sp" runat="server" href="FYPCoordinatorEditProfile.aspx">Edit Profile</a>
									<a class="dropdown-item active" id="cp" runat="server" href="FYPCoordinatorChangePassword.aspx">Change Password</a>									
                ...
                <li class="user_setting">
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	...
					    	<div class="user_setting_content">
								<a class="dropdown-item" id="sp1" runat="server" href="FYPCoordinatorEditProfile.aspx">Edit Profile</a>
									<a class="dropdown-item active" id="cp1" runat="server" href="FYPCoordinatorChangePassword.aspx">Change Password</a>									
									<a class="dropdown-item" href="FYPCoordinatorLogin.aspx">Log out</a>
...
<asp:TextBox ID="ConPassword" type="password" class="form-control" runat="server"></asp:TextBox>                            
           ...
           <asp:Button class="btn btn-log btn-block btn-thm2" ID="BtnUpdate" runat="server"  Text="Update" OnClick="BtnUpdate_Click1"/>  
            ...
            <td><asp:TextBox ID="TextBox1" type="hidden" Text="02-131162-041" runat="server"></asp:TextBox></td>
        </tr>

        <tr>
            <td>Old Password</td> <td>  </td>
            <td><asp:TextBox ID="OldPassword" type="Text" runat="server"></asp:TextBox></td>
<td>  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="OldPassword" Display="Dynamic" 
    ErrorMessage="This field is required." ForeColor="Red" SetFocusOnError="true">
        ...
        <tr>
            ...
            <td>  <asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="NewPassword" Display="Dynamic"
      ErrorMessage="This field is required." ForeColor="Red" SetFocusOnError="true">
      </asp:RequiredFieldValidator>  
</td>
        </tr>
        ...
        <tr>
            ...
            <td>  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ConPassword" Display="Dynamic"
      ErrorMessage="This field is required." ForeColor="Red" SetFocusOnError="true">
      </asp:RequiredFieldValidator>
</td>
        </tr>
