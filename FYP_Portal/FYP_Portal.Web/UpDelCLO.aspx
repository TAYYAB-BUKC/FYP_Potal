<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpDelCLO.aspx.cs" Inherits="FYP_Portal.Web.UpDelCLO" %>
...
<title>Update/Delete Course Learning Outcomes</title>
...
<li class="active"><a runat="server" href="UpDelCLO.aspx"><span class="flaticon-add-contact"></span>Update/Delete CLO </a></li>
  ...
  <div class="dd-content">
	...
	<div class="col-lg-12">
		<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
			<h4 class="title float-left">Update/Delete Course Learning Outcomes</h4>
		</nav>
	</div>
   						<div class="col-lg-12">
...
<asp:RadioButton OnCheckedChanged="upclo_CheckedChanged" ID="upclo" Width="100px" Text="Update CLO" 
    GroupName="RadioGroup" runat="server" AutoPostBack="True" />   
   
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<asp:RadioButton OnCheckedChanged="delclo_CheckedChanged" ID="delclo" Text="Delete CLO" 
    GroupName="RadioGroup" runat="server" AutoPostBack="True" />
				
<div runat="server" id="update">
  <asp:DropDownList OnSelectedIndexChanged="updateclo_SelectedIndexChanged" ID="updateclo" Width="100%" 
...
<textarea ID="Description" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />
 ...
 <asp:Label runat="server" Text="OutStanding"></asp:Label> <br />
 <textarea ID="outs" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />

 <asp:Label runat="server" Text="Good"></asp:Label> <br />
 <textarea id="good" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />
                      
 <asp:Label runat="server" Text="Average"></asp:Label> <br />
  <textarea id="avg" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />

 <asp:Label runat="server" Text="Satisfactory"></asp:Label> <br />
 <textarea id="satisfactory" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />

 <asp:Label runat="server" Text="Poor"></asp:Label> <br />
 <textarea id="poor" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />

 <asp:Label runat="server" Text="Fail"></asp:Label> <br />
 <textarea id="fail" class="form-control" cols="85" rows="3" runat="server"></textarea> <br />


<asp:Button OnClick="Unnamed_Click" class="btn btn-primary" runat="server" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Width="120px" Text="Update CLO" />     
</div>


<div runat="server" id="delete">
<asp:DropDownList ID="deleteclo" Width="100%" class="form-control" runat="server" AutoPostBack="False">     
 </asp:DropDownList> 
    <br />
  <asp:Button OnClick="Unnamed_Click1" class="btn btn-primary" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Width="120px" runat="server" Text="Delete CLO" /><br /><br />
         </div>                             
           </form>
