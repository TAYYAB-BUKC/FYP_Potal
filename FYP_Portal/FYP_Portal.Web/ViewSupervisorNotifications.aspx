<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSupervisorNotifications.aspx.cs" Inherits="FYP_Portal.Web.ViewSupervisorNotifications" %>
...
<li class="active"><a runat="server" href="ViewSupervisorNotifications.aspx"><span class="flaticon-speech-bubble"></span> Notifications</a></li>						
		...
		<div class="my_course_content mb30">
			<div class="my_course_content_header">
					 ...
					 <form id="form" runat="server">
                           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="742px" >
                        <Columns>
