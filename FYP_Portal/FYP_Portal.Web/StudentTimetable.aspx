<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentTimetable.aspx.cs" Inherits="FYP_Portal.Web.StudentTimetable" %>
...
<div id="myDrop2" class="drop-content">
	...
	<li class="active"><a runat="server" href="StudentTimetable.aspx"><span class="flaticon-like"></span> Student Timetable</a></li>
...
<li><a runat="server" href="GradeDetailsForFYPCoordinator.aspx"><span class="flaticon-rating"></span>Student Grades</a></li>
 ...
 <div class="dd">
  ...
  <div class="dd-content">
    ...
    <li><a runat="server" href="RegisterSupervisor.aspx"><span class="flaticon-like"></span> Register Supervisors</a></li>
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
    <li><a runat="server" href="RegisterFYPCoordinator.aspx"><span class="flaticon-like"></span> Register FYPCoordinators</a></li>
 	 </ul>
     </div>
    </div> 
   </ul>    
			...
			<div class="col-lg-12">
				<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
					<h4 class="title float-left">Students Timetable</h4>
				</nav>
			</div>
...
<table id="std_table" class="table table-nonbordered table-condensed info table-responsive tableCol1">
        ...
        <tr>               
          <td> 
    <asp:DropDownList ID="students" Width="90%" class="form-control" runat="server">
    </asp:DropDownList>
          </td> 
