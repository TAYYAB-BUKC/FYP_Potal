<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupervisorLogin.aspx.cs" Inherits="FYP_Portal.Web.SupervisorLogin" %>
				...
				<div class="col-sm-12 col-lg-6 offset-lg-3">
					<div class="login_form inner_page">
						<form action="#" runat="server">
							<div class="heading">
								<h3 class="text-center">SUPERVISOR LOGIN</h3></div>

							 <div class="form-group">
                                 <label class="control-label"> Username 
<asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="uname" Display="Dynamic" 
...
<asp:DropDownList ID="inst" class="form-control" runat="server">
           ...
           <a class="tdu btn-fpswd float-right" href="SupervisorForgotPassword.aspx">Forgot Password?</a>
			</div>

<asp:Button type="submit" class="btn btn-log btn-block btn-thm2" ID="BtnSvLogin" style="margin-left:auto;margin-right:auto;display:block;border-radius:6px" Width="200px" runat="server" Text="Login" OnClick="BtnSvLogin_Click" />						
						</form>
					</div>
				</div>
			</div>
