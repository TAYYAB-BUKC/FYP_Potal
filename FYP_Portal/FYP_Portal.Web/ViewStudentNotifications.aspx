<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewStudentNotifications.aspx.cs" Inherits="FYP_Portal.Web.ViewStudentNotifications" %>
...
<li class="active"><a id="notify" runat="server" href="ViewStudentNotifications.aspx"><span class="flaticon-speech-bubble"></span>Notifications</a></li>
...
<li><a id="doc" runat="server" href="Documents.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
	...
	<div class="our-dashbord dashbord">
		...
		<li class="active"><a id="notify1" runat="server" href="ViewStudentNotifications.aspx"><span class="flaticon-speech-bubble"></span>Notifications</a></li>
	 ...
	 <form id="form" runat="server">
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" >
       ...
       <asp:TemplateField>
           ...
           <ItemTemplate>
               <%# Eval("message").ToString().Length > 110 ? (Eval("message") as string).Substring(0,110) : Eval("message")  %>
           </ItemTemplate>
      </asp:TemplateField>
       <asp:BoundField DataField="sent" HeaderText="Sent By" />
                         
                        </Columns>

   <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
   <HeaderStyle BackColor="#000080" Font-Bold="True" ForeColor="#FFFFCC" />
