<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubmitDocument.aspx.cs" Inherits="FYP_Portal.Web.SubmitDocument" %>
...
<li class="active"><a id="doc1" runat="server" href="Documents.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
 ...
 <table class="table table-bordered table-condensed info table-responsive tableCol4">
					...
					<td id="docTitle" runat="server"> </td>
					<th>File</th>
					<td id="file" runat="server"> 
                    <asp:FileUpload ID="FileUpload1" runat="server" /> </td>
				    </tr>              
</table>
    
<asp:Button ID="Submit" runat="server" class="btn btn-primary" Text="Submit File" OnClick="Submit_Click"/>		
                                          
     <asp:Label ID="docid" runat="server" ></asp:Label>

</form> 
       </div>                                    
     <asp:Label ID="enrollment" runat="server" ></asp:Label>                    
                    		   </div>
                         </div>
                    </div>
			    </div>
