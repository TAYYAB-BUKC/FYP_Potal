<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentAttendanceSummary.aspx.cs" Inherits="FYP_Portal.Web.StudentAttendanceSummary" %>
							...
							<div class="my_course_content_container">
								<div class="my_course_content mb30">
									<div class="my_course_content_header">	
                                        <form id="attendance" runat="server" visible="True">
<asp:Label ID="messageLabel" runat="server" ></asp:Label>
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowFooter="False" >
                        <Columns>
