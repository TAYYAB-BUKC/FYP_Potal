<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EIMapping.aspx.cs" Inherits="FYP_Portal.Web.EIMapping" %>
...
<title>Evaluation Instruments Mapping</title>
...
<div id="myDrop3" class="drop-content">
    ...
    <li class="active"><a runat="server" href="EIMapping.aspx"><span class="flaticon-like"></span> E.I Mapping</a></li>
</ul>
   </div>
</div>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
		...
		<div class="col-lg-12">
			<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
				<h4 class="title float-left">Evaluation Instruments Mapping</h4>
			</nav>
		</div>
...
<asp:DropDownList ID="EIParameters" class="form-control" Width="450px" runat="server">
    <asp:ListItem Text="Mid Year Evaluation" />
    <asp:ListItem Text="Final Year Evaluation" />
    <asp:ListItem Text="FYP Report" />
    <asp:ListItem Text="Log Book" />
  </asp:DropDownList>                            
                            <br />
