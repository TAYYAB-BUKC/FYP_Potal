<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewStudentTimetable.aspx.cs" Inherits="FYP_Portal.Web.ViewStudentTimetable" %>
...
<li class="active"><a runat="server" href="ViewStudentTimetable.aspx"><span class="flaticon-like"></span> Student Timetable</a></li>
...
<li><a runat="server" href="Files.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
                         ...
                         <form id="form2" runat="server">                     
                             ...
                             <br />
<img alt="Timetable.png" height="450" width="950" src="" id="image" runat="server"/>
