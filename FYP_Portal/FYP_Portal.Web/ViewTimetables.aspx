<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTimetables.aspx.cs" Inherits="FYP_Portal.Web.ViewTimetables" %>
...
<div id="myDrop2" class="drop-content">
	...
	<li class="active"><a runat="server" href="ViewTimetables.aspx"><span class="flaticon-like"></span> View Timetables</a></li>
    </ul>
   </div>
</div>
  <br /> <br />
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
						...
						<div class="col-lg-12">
									<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
										<h4 class="title float-left">View Timetables</h4>
									</nav>
								</div>
...
<asp:RadioButton OnCheckedChanged="ViewSupTime_CheckedChanged" ID="ViewSupTime" 
    Text="View SuperVisor Timetable" GroupName="RadioGroup" runat="server" AutoPostBack="True" />   
   
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<asp:RadioButton OnCheckedChanged="ViewStdTime_CheckedChanged" ID="ViewStdTime" 
    Text="View Student Timetable" GroupName="RadioGroup" runat="server" AutoPostBack="True" />
				
                             <div runat="server" id="StudentsDiv">
<asp:DropDownList OnSelectedIndexChanged="students_SelectedIndexChanged" ID="students" Width="100%" 
    class="form-control" runat="server" AutoPostBack="True"> </asp:DropDownList> 
         
      <img alt="Timetable.png" height="450" width="950" src="" id="stdImage" runat="server"/>
                     <Label id="StdError" runat="server" />      
                             </div>

                             <div runat="server" id="SuperDiv">
<asp:DropDownList OnSelectedIndexChanged="supervisors_SelectedIndexChanged" ID="supervisors" Width="100%" 
    class="form-control" runat="server" AutoPostBack="True"> </asp:DropDownList> 
 
     <img alt="Timetable.png" height="450" width="950" src="" id="supImage" runat="server"/>
 <Label id="SupError" runat="server" />
                             </div>
                 </form>
