<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FYPCoordinatorEditProfile.aspx.cs" Inherits="FYP_Portal.Web.FYPCoordinatorEditProfile" %>
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="pemail" Display="Dynamic" 
    ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>	
						    	</label> 
