<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeDetailsForFYPCoordinator.aspx.cs" Inherits="FYP_Portal.Web.GradeDetailsForFYPCoordinator" %>
...
<li class="active"><a runat="server" href="GradeDetailsForFYPCoordinator.aspx"><span class="flaticon-rating"></span>Student Grades</a></li>
</ul>                       
...
<li class="active"><a runat="server" href="GradeDetailsForFYPCoordinator.aspx"><span class="flaticon-rating"></span>Student Grades</a></li>
 ...
 <asp:DropDownList ID="groupNumber" Width="100%" Enabled="true" AutoPostBack="true" OnSelectedIndexChanged="groupNumber_SelectedIndexChanged" class="form-control" runat="server" >
	  ...
	  <asp:Button class="btn btn-primary" ID="MidYearMarks" Text="Mid Year Marks" OnClick="MidYearMarks_Click" runat="server" />
      <asp:Button class="btn btn-primary" ID="FinalYearMarks" Text="Final Year Marks" OnClick="FinalYearMarks_Click" runat="server" />
      <asp:Button class="btn btn-primary" ID="GenerateMarks" Text="OverAll Marks" OnClick="GenerateMarks_Click" runat="server" />
