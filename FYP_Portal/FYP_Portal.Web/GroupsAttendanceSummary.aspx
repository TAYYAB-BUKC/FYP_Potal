<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupsAttendanceSummary.aspx.cs" Inherits="FYP_Portal.Web.GroupsAttendanceSummary" %>
...
<title>Groups Attendance Summary</title>
...
<div class="wrapper">
    ...
    <section class="dashboard_sidebar dn-1199">
     ...
     <ul>
		...
		<li class="active"><a runat="server" href="GroupsAttendanceSummary.aspx"><span class="flaticon-rating"></span>Attendance Summary</a></li>
      </ul>   
...
<li><a runat="server" href="GradeDetailsForFYPCoordinator.aspx"><span class="flaticon-rating"></span>Student Grades</a></li>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Groups Attendance Summary </h4>
							</nav>
						</div>
 ...
 <form id="form1" runat="server" visible="True">
     	...
     	<h4> Group Names </h4> <br />    
     <asp:DropDownList ID="groups" Class="form-control" Width="100%" runat="server" OnSelectedIndexChanged="groups_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
     <br />           
                        ...
                        <Columns>
                            <asp:BoundField DataField="enrollment" HeaderText="Enrollment No." />
                             <asp:BoundField DataField="name" HeaderText="Student Name" />
                                <asp:BoundField DataField="meetings" HeaderText="Total Meetings" />
