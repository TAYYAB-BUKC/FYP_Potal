<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpDelPLO.aspx.cs" Inherits="FYP_Portal.Web.UpDelPLO" %>
...
<title> Update/Delete Program Learning Outcomes </title>
...
<div class="wrapper">
	...
	<img class="rounded-circle" id="p" runat="server" alt="profile.png" src="" />
						...
						<a class="dropdown-item active" id="sp" runat="server" href="FYPCoordinatorEditProfile.aspx">Edit Profile</a>
								...
								<a class="dropdown-item" href="FYPCoordinatorLogin.aspx">Log out</a></div>
						    </div>						
			        </li>
	            </ul>
		    </nav>
...
<li class="active"><a runat="server" href="UpDelPLO.aspx"><span class="flaticon-add-contact"></span>Update/Delete PLO  </a></li>
    </ul>
</div>
</div>
<br /> <br />
...
<li><a runat="server" href="CLOPLOMapping.aspx"><span class="flaticon-add-contact"></span> CLO/PLO Mapping </a></li>
<li><a runat="server" href="UpDelCLO.aspx"><span class="flaticon-add-contact"></span>Update/Delete CLO </a></li>
<li class="active"><a runat="server" href="UpDelPLO.aspx"><span class="flaticon-add-contact"></span>Update/Delete PLO  </a></l>
    </ul>
  </div>
</div>  
<li><a runat="server" href="ViewGroups.aspx"><span class="flaticon-add-contact"></span> Groups</a></li>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
								...
								<div class="col-lg-12">
									<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
										<h4 class="title float-left">Update/Delete Program Learning Outcomes</h4>
									</nav>
								</div>
...
<asp:RadioButton OnCheckedChanged="upplo_CheckedChanged" ID="upplo" Text="Update PLO" 
    GroupName="RadioGroup" runat="server" AutoPostBack="True" />   
      
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<asp:RadioButton OnCheckedChanged="delplo_CheckedChanged" ID="delplo" Text="Delete PLO" 
    GroupName="RadioGroup" runat="server" AutoPostBack="True" />
				
<div runat="server" id="update">
  <asp:DropDownList OnSelectedIndexChanged="updateplo_SelectedIndexChanged" ID="updateplo" Width="100%" 
      class="form-control" runat="server" AutoPostBack="True"> </asp:DropDownList> <br />

     <asp:Label runat="server" Text="Description"></asp:Label> <br />
<textarea ID="Description" cols="85" rows="5" class="form-control" runat="server"></textarea> <br />

        <asp:Button OnClick="Unnamed_Click" class="btn btn-primary" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Width="120px" runat="server" Text="Update PLO" /> <br /><br />
</div>
          
   <br />
<div runat="server" id="delete">
 <asp:DropDownList ID="deleteplo" Width="100%" class="form-control" runat="server" AutoPostBack="False">     
 </asp:DropDownList> <br />

   <asp:Button OnClick="Unnamed_Click1" class="btn btn-primary" runat="server" 
   style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Width="120px" Text="Delete PLO" />      
</div>                 
 </form>
