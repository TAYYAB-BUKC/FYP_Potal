<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentEditProfile.aspx.cs" Inherits="FYP_Portal.Web.StudentEditProfile" %>
...
<form id="form1" runat="server">							
   ...
   <asp:TextBox ID="Name" class="form-control" ReadOnly="true" runat="server" ></asp:TextBox>					    	

                            </div>
							<div class="my_profile_setting_input form-group">
						      <label class="control-label"> Department </label> 
<asp:TextBox ID="depart" type="text" ReadOnly="true" class="form-control" runat="server"></asp:TextBox>						    	
                        </div>
						</div>
...
<asp:TextBox ID="inst" type="text" class="form-control" ReadOnly="true" runat="server" Text="BSE" placeholder="Department"></asp:TextBox>
...
<asp:TextBox ID="class1" type="text" class="form-control" runat="server" ReadOnly="true" placeholder="University Email"></asp:TextBox>
					</div>							
						</div>
						...
						<div class="my_profile_setting_input form-group">
        <div class="my_profile_setting_input form-group">
                                <label class="control-label"> Personal Email
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="pemail" 
