<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewGroups.aspx.cs" Inherits="FYP_Portal.Web.ViewGroups" %>
...
<br /> <br />
                                <ul>
<li class="active"><a runat="server" href="ViewGroups.aspx"><span class="flaticon-add-contact"></span> Groups</a></li>
                                </ul>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
            ...
            <div class="col-lg-12">
            	<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
            		<h4 class="title float-left">View Groups</h4>
            	</nav>
            </div>
                   ...
                   <form id="group" runat="server" visible="True">
                      
                       <h4>Group Names</h4>
                       <br />
<asp:DropDownList ID="groups" class="form-control" runat="server" 
    OnSelectedIndexChanged="groups_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                       <br />
                   ...
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                        <Columns>
                            ...
                            <asp:BoundField DataField="registration" HeaderText="Registration No." />
