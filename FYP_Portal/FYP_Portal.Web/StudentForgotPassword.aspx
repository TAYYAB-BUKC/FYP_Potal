<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentForgotPassword.aspx.cs" Inherits="FYP_Portal.Web.StudentForgotPassword" %>
            ...
            for (var i = 0; i < Page_Validators.length; i++) {
                ...
                if (ctrl != null && ctrl.style != null) {
                    if (!val.isvalid) {
                       ...
                       // document.getElementById(val.controltovalidate).style.borderColor = 'green';
                    }
                }
            }
        }
			...
			<div class="row">
				<div class="col-sm-12 col-lg-6 offset-lg-3">
					<div class="sign_up_form inner_page">
						<div class="heading">
							<h3 class="text-center">Student Forgot Password</h3>							
						</div>
