<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarkAttendance.aspx.cs" Inherits="FYP_Portal.Web.MarkAttendance" %>
...
<li><a runat="server" href="Files.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Mark Attendance</h4>								
							</nav>
						</div>
 ...
 <form id="attendance" runat="server">                    
       <table id="std_table" class="nonbordered tableCol4">
                <tr>
					<th>Group Name: </th>	            
                    <td> <asp:Label ID="grpname" class="control-label" runat="server"></asp:Label> </td>                                  
				</tr>
    ...
    <h4>Remarks</h4>
 <textarea id="Remarks" class="form-control" cols="85" rows="3" runat="server"></textarea> 
         </div>
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:RadioButton ID="Absent" Text="Absent" Checked="true" GroupName="RadioGroup"  runat="server" />
                                    <asp:RadioButton ID="Present" Text="Present" runat="server" GroupName="RadioGroup" />
                                </ItemTemplate>
                                <ItemStyle Width="25%" />
                            </asp:TemplateField>
                        </Columns>
...
<asp:Button class="btn btn-primary" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" Width="100px" ID="Btn_save" runat="server" Text="Save" OnClick="Btn_save_Click" />  
                        </form>    
