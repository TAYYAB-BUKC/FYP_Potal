<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAttendance.aspx.cs" Inherits="FYP_Portal.Web.ViewAttendance" %>
	...
	<section class="dashboard_sidebar dn-1199">
		<div class="dashboard_sidebars">
	        ...
	        <ul>
						...
						<li class="active"><a id="view" runat="server" href="ViewAttendance.aspx"><span class="flaticon-rating"></span> Attendance</a></li>                       
...
<li class="active"><a id="view1" runat="server" href="ViewAttendance.aspx"><span class="flaticon-rating"></span> Attendance</a></li>                       
...
<li><a id="doc1" runat="server" href="Documents.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Attendance Summary </h4>
							</nav>
						</div>
                   ...
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowFooter="True" >
                        <Columns>
                            <asp:BoundField DataField="enrollment" HeaderText="Enrollment No." />
                             ...
                             <asp:BoundField DataField="marked" HeaderText="Marked on Date/Time" />
