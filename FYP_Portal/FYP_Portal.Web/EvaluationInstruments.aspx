<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EvaluationInstruments.aspx.cs" Inherits="FYP_Portal.Web.EvaluationInstruments" %>
...
<div id="myDrop3" class="drop-content">
    <ul>
    <li class="active"><a runat="server" href="EvaluationInstruments.aspx"><span class="flaticon-like"></span> Evaluation Instruments</a></li>
    ...
    <li><a runat="server" href="RegisterStudent.aspx"><span class="flaticon-like"></span> Register Students</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">Evaluation Instruments</h4>
							</nav>
						</div>
