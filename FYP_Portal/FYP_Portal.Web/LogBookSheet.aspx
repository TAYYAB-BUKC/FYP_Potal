<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogBookSheet.aspx.cs" Inherits="FYP_Portal.Web.LogBookSheet" %>
...
<title>Log Book Evaluation Sheet</title>
...
<li class="active"><a runat="server" href="LogBookSheet.aspx"><span class="flaticon-rating"></span>LogBook Sheet</a></li>						--%>
    </ul>
</div>
</div>
                     <br /> <br />
...
<li><a runat="server" href="Files.aspx"><span class="flaticon-add-contact"></span> Documentation</a></li>
						...
						<div class="col-lg-12">
							<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
								<h4 class="title float-left">LogBook Evaluation Sheet</h4>
							</nav>
						</div>
 ...
 <asp:DropDownList ID="studentName" Width="100%" Enabled="true" class="form-control" runat="server" OnSelectedIndexChanged="studentName_SelectedIndexChanged" AutoPostBack="true" >
         ...
         <div class="col-xl-6">
							<div class="my_profile_setting_input form-group">
<asp:Button ID="GenerateReport" class="btn btn-primary" style="margin-left:auto;margin-right:auto;display:block;margin-top:1%" runat="server" Text="Generate Report" OnClick="GenerateReport_Click" />
