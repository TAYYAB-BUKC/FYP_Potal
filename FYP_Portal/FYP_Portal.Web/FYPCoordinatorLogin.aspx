<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FYPCoordinatorLogin.aspx.cs" Inherits="FYP_Portal.Web.FYPCoordinatorLogin" %>
				...
				<div class="col-sm-12 col-lg-6 offset-lg-3">
					<div class="login_form inner_page">
						<form action="#" runat="server">
							<div class="heading">
								<h3 class="text-center">FYP COORDINATOR LOGIN</h3>
							</div>

							 <div class="form-group">
                                 <label class="control-label"> Email 
<asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="pemail" Display="Dynamic" 
    ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator></label> 
						
<asp:TextBox ID="pemail" type="email" class="form-control" runat="server" placeholder="Email"></asp:TextBox>    
                             </div>

							<div class="form-group">
                                <label class="control-label"> Password  

<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="pwd" Display="Dynamic" 
    ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator></label>
<asp:TextBox ID="pwd" type="password" class="form-control" runat="server" placeholder="Password"></asp:TextBox>
							</div>

                             <div class="form-group custom-control custom-checkbox">                                
		<a class="tdu btn-fpswd float-right" href="FYPCoordinatorForgotPassword.aspx">Forgot Password?</a>
   </div>
                            
<asp:Button class="btn btn-log btn-block btn-thm2" runat="server" style="margin-left:auto;margin-right:auto;display:block;border-radius:6px" Width="200px" Text="Login" OnClick="BtnFypLogin_Click" />
				<br />			<br />
						</form>
					</div>
				</div>
